...
if 'pending_video_url' not in cols:
    cur.execute("ALTER TABLE vehicles ADD COLUMN pending_video_url VARCHAR(500)")
    print("✅ Added pending_video_url column to vehicles")
else:
    print("✅ pending_video_url already exists")
